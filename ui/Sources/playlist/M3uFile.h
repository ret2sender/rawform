...
/**
 * @brief The M3U export path: a playlist as a plain list of file references
 *        that other players can read.
 *
...
/**
 * @brief Write @p doc to @p path as a plain M3U, atomically.
 *
